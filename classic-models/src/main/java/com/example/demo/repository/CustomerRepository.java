...
public interface CustomerRepository extends JpaRepository<Customers, Integer> {
	...
	public List<Customers> getCustwithCountry(String country);

	@Transactional
	@Query(value = "select distinct country from customers;", nativeQuery = true)
	...
	@Transactional
	@Query(value = "select round(avg(credit_limit),2) average,  customer_number, ifnull(address_line1, concat(address_line1, ' ', address_line2)) addresses,\r\n"
			+ "country\r\n" + "from customers group by country;", nativeQuery = true)
	public List<Object[]> getDatax1();
